...
// 	}
  ...
  const handleSubmit = async (event: any) => {
	...
	try {
		const response = await fetch('https://1991-63-176-105-72.ngrok-free.app/api/registers', {
			method: 'POST',
			headers: {
				'Content-Type': 'application/json',
			},
        ...
        <div className={style.image_container}>
          ...
          <div className={style.overlay}>
            ...
            <div className={style.submit_box}>
              <div className={style.signup} onClick={e => handleSubmit(e)} style={{
				backgroundColor: active ? '#59c960' : 'rgba(194, 218, 194, 0.322)',}}>Sign Up</div>
              <div className={style.login} onClick={e => handleLogin(e)} 
				style={{
					backgroundColor: passive ? '#59c960' : 'rgba(194, 218, 194, 0.322)',}}
					>Log In</div>
            </div>
          </div>
        </div>
